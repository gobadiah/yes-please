...
const getTopic = topicName => new Promise((resolve, reject) => {
  const pubsub = Pubsub();
...
module.exports.publish = (topicName, data) => new Promise((resolve, reject) => {
  getTopic(topicName)
    .then((topic) => {
...
module.exports.subscribe = (topicName, subscriptionName, handler) => {
